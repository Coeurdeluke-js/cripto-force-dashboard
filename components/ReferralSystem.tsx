    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#1a1a1a] to-[#2a2a2a] rounded-lg p-6">
        <h2 className="text-2xl font-bold text-[#8A8A8A] mb-2">
          🎯 Sistema de Referidos Crypto Force
        </h2>
        <p className="text-gray-400">
          Invita a otros usuarios y gana comisiones por cada referido exitoso
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-800">Tu Código de Referido</h3>
        ...
        <div className="space-y-3">
          <h4 className="font-medium text-gray-700">Enlace de Registro</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
          <div className="text-center">
            ...
            <div className="text-gray-600">Referidos Totales</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
          <div className="text-center">
            ...
            <div className="text-gray-600">Tu Nivel</div>
          </div>
        </div>
      </div>
      ...
      {stats.recent_referrals.length > 0 && (
        <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Referidos Recientes</h3>
          <div className="space-y-3">
      ...
      {showShareModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <h3 className="text-lg font-semibold mb-4">Compartir Código de Referido</h3>
