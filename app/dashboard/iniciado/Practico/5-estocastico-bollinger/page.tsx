    ...
    <div className="min-h-screen bg-[#121212] text-white px-2 sm:px-8 py-8 max-w-3xl mx-auto">
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 pt-12 relative">
        ...
        <section className="mb-8">
          ...
          <p className="mb-6">En este módulo aprenderás a utilizar el oscilador estocástico y las bandas de Bollinger como herramientas fundamentales para identificar niveles de sobrecompra/sobreventa y oportunidades de trading en mercados con rangos definidos.</p>
          ...
          <div className="bg-[#1a1a1a] rounded-lg p-6 mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>Comprender el funcionamiento del oscilador estocástico</li>
              <li>Aprender a identificar niveles de sobrecompra y sobreventa</li>
              <li>Entender las bandas de Bollinger y su aplicación en mercados con rango</li>
              <li>Identificar divergencias y señales de cruce</li>
          ...
          <div className="text-center">
            <Link 
              href="/dashboard/iniciado/Practico/5-estocastico-bollinger/contenido"
