          ...
          <div className="space-y-8">
            ...
            <div className="bg-[#181818] rounded-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-semibold text-[#ec4d58] mb-2">Ejemplo Práctico</h4>
                ...
                <div>
                  <h4 className="font-semibold text-[#ec4d58] mb-2">Cálculos de Fibonacci</h4>
                  <div className="space-y-3">
                    <div>
                      <p className="text-sm font-semibold">• La línea del 38,2%.</p>
                      <p className="text-sm">Calcula el 38,2% del tamaño del movimiento significativo del precio. El tamaño del movimiento significativo del precio en este caso es (1,000) menos el límite inferior (0). En este caso, el tamaño del movimiento significativo del precio es 1.000 pips. 0,382 x 1000 = 382 pips. Se espera que el activo retroceda 382 puntos desde su pico. Asumiendo que el activo aumenta de 0 a 1.000, retrocedería 382 pips de 1.000. 1.000 – 382 = 618. Por lo tanto, este es un nivel clave en el que hay que estar atento; usted querrá comprar en este nivel (618) ya que se espera que la tendencia alcista comience nuevamente después de alcanzar este nivel de retroceso.</p>
                    </div>
                    <div>
                      <p className="text-sm font-semibold">• La línea del 50,0%.</p>
                      <p className="text-sm">Misma situación; el 50% del movimiento significativo del precio (1.000 pips) es 500. Réstelo del límite superior (1.000) ya que es una tendencia alcista. 1.000 – 500 = 500. Esté atento a la tendencia alcista que comenzará nuevamente en ese punto.</p>
                    </div>
                    <div>
                      <p className="text-sm font-semibold">• La línea del 61,8%.</p>
                      <p className="text-sm">El 61,8% del movimiento significativo del precio es 618. 1.000 – 618 = 382. Si el activo retrocede hasta este punto, se considera que es una oportunidad de compra.</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="font-semibold text-[#ec4d58] mb-2">Otros Niveles de Fibonacci</h4>
                ...
                <div>
                  <h4 className="font-semibold text-[#ec4d58] mb-2">Parámetros Clave</h4>
                  <p className="text-sm mb-3">38,2%, 50,0%, y 61,8% son los niveles de Fibonacci más comunes. Se considera que el nivel de 38,2% es el menos significativo de los tres niveles principales de Fibonacci. A mayor línea de porcentaje (es decir, 61,8%) mayor será la probabilidad de que el precio encuentre soporte.</p>
                </div>

                <div>
                  <h4 className="font-semibold text-[#ec4d58] mb-2">Concepto Clave: Busque la confirmación</h4>
                  <ul className="text-sm space-y-2 mb-3">
                    <li>• Los operadores deberían ingresar cuando obtienen la confirmación (por ejemplo, los patrones de vela clave) en los niveles de Fibonacci.</li>
                    <li>• Los operadores también pueden obtener la confirmación utilizando una variedad de otros indicadores, tal como veremos en el transcurso del curso.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#181818] rounded-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-sm font-semibold">1. Identifique el punto más bajo y más alto de la tendencia.</p>
                    <p className="text-sm">Al punto más bajo se lo denomina soporte y al punto más alto, resistencia. Si bien son subjetivos, los niveles de soporte y resistencia pueden determinarse fácilmente mirando simplemente el gráfico.</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold">2. Utilizando el paquete de gráficos que a usted más le guste, trace las líneas de Fibonacci desde el nivel de soporte hacia el nivel de resistencia.</p>
                    <p className="text-sm">Deberían aparecer las tres líneas: Una en el 38,2% de la diferencia desde el punto máximo al mínimo; otra en el 50% y otra en el 61,8%. Estos son los niveles de Fibonacci claves en base a los cuales usted debería buscar oportunidades potenciales para ingresar operaciones.</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold">3. Después de eso, simplemente observe el comportamiento del precio para confirmar la oportunidad de ingresar una operación.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#181818] rounded-lg p-6">
              ...
              <div className="space-y-4">
                <p className="text-sm">TRABAJO PRÁCTICO: utilizando la aplicación de gráficos que desee, trace las líneas de retroceso de Fibonacci en gráficos para los diferentes pares de divisas a los que accede desde su plataforma de operaciones. Luego, una vez analizados los gráficos, busque oportunidades de compraventa en base a los retrocesos de Fibonacci.</p>
                <p className="text-sm mb-3">Responda informándonos qué operación colocó y por qué la colocó.</p>
            ...
            <div className="bg-[#181818] rounded-lg p-6">
              ...
              <div className="space-y-4">
                <p className="text-sm">Muchos operadores consideran que los niveles de Fibonacci sólo son importantes porque los niveles son altamente publicitados y otros operadores tienen conocimiento de los mismos. Esta profecía autocumplida tiene el efecto de hacer significativos a estos niveles porque muchos operadores los consideran niveles importantes.</p>
            ...
            <div className="bg-[#181818] rounded-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#1a1a1a] rounded-lg p-4">
                  <p className="text-sm text-gray-300">La prueba estará disponible próximamente para evaluar su comprensión de los retrocesos de Fibonacci.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#181818] rounded-lg p-6">
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-[#ec4d58] mb-2">¿En qué consisten las medias móviles?</h4>
                ...
                <div>
                  <h4 className="font-semibold text-[#ec4d58] mb-2">Evalúe la Tendencia Global</h4>
                ...
                <div>
                  <h4 className="font-semibold text-[#ec4d58] mb-2">Confirmación del Comportamiento del Precio</h4>
                ...
                <div>
                  <h4 className="font-semibold text-[#ec4d58] mb-2">Cruces</h4>
            ...
            <div className="bg-[#181818] rounded-lg p-6">
              ...
              <div className="space-y-4">
                <p className="text-sm">En la primera parte de esta lección introdujimos el concepto de que los niveles de retroceso de Fibonacci son importantes porque un gran número de operadores los conocen y se convierten en una profecía autocumplida.</p>
            ...
            <div className="bg-[#181818] rounded-lg p-6">
              ...
              <div className="space-y-4">
                <p className="text-sm">Por favor, evalúe el conocimiento que aprendió en esta lección.</p>
                <div className="bg-[#1a1a1a] rounded-lg p-4">
                  <p className="text-sm text-gray-300">La prueba estará disponible próximamente para evaluar su comprensión de las medias móviles.</p>
                </div>
              </div>
            </div>
          </div>
