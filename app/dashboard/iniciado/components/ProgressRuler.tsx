...
import { CheckCircle, Lock, Unlock, Eye } from 'lucide-react';
      ...
      <div className="relative">
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex items-center space-x-2">
            <span className="text-sm text-gray-400">Punto de Inicio</span>
            <div className="w-3 h-3 bg-[#ec4d58] rounded-full"></div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <span className="text-sm text-gray-400">Meta Final</span>
