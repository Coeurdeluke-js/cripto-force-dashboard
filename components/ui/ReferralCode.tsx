  ...
  return (
    <div className="bg-[#1e2028]/80 backdrop-blur-sm rounded-xl p-6 border border-white/10">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-white">Mi Código de Referido</h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 pt-4">
          <div className="bg-[#2a2d36]/50 rounded-lg p-4 text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-white/60 text-sm">Referidos</span>
            </div>
        ...
        <div className="bg-[#2a2d36]/30 rounded-lg p-4">
          ...
          <ul className="text-white/70 text-sm space-y-1">
            ...
            <li>• Ganas comisiones por cada referido activo</li>
            <li>• Los beneficios aumentan con más referidos</li>
          </ul>
        </div>
      </div>
    </div>
