          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#1a1a1a] border border-[#232323] rounded-2xl p-8 mb-8">
              <div className="text-center">
                <div className={`text-6xl mb-4 ${aprobado ? 'text-green-500' : 'text-red-500'}`}>
                  {aprobado ? '✅' : '❌'}
                </div>
                <h2 className="text-2xl font-bold mb-4">
                  {aprobado ? '¡Felicitaciones! Has aprobado' : 'Necesitas más estudio'}
                </h2>
                <div className="text-4xl font-bold mb-4">
                  {respuestasCorrectas}/{totalPreguntas} correctas
                </div>
                <div className="text-2xl mb-6">
                  {porcentajeAprobacion.toFixed(1)}%
                </div>
