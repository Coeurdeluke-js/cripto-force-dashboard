...
// Sistema de votación unánime donde TODOS los Maestros deben aprobar
...
export class TribunalVotingSystem {
  ...
  static processVote(
    ...
    if (maestrosLevel !== 6) {
      return {
        ...
        message: 'Solo los Maestros pueden votar en el Tribunal Imperial',
  ...
  private static calculateProposalStatus(
    ...
    // Si no se requiere aprobación unánime (configuración alternativa)
